...
CREATE TABLE `prefrences` (
  ...
  `prefred_location` varchar(100) DEFAULT NULL,
  ...
  KEY `emp_id` (`emp_id`),
  CONSTRAINT `prefrences_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `emp_basic_details` (`emp_id`)
...
INSERT INTO `prefrences` VALUES (1,1,'banglore ','3','5000000000','1000000','design');
